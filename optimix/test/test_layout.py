...
def test_quadratic1scalar2_layout():
    ...
    assert_almost_equal(
        f.gradient(x), [-345.59999999999997, 230.39999999999998])
...
def test_quadratic4scalar2_layout():
    ...
    assert_almost_equal(
        f.gradient(x1, x2), [-8167.4789255926462, 5444.9859503950975])
...
def test_vectorvalued1scalar2_layout():
    ...
    assert_almost_equal(
        f.gradient(x), [array([-432., -288., -0.]), array([288., 192., 0.])])
...
def test_vectorvalued2scalar2_layout():
    ...
    assert_almost_equal(
        f.gradient(x1, x2), [array([-12., -8., -0.]), array([0., -36., 12.])])
